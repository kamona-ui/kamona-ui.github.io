    ...
    return () => (
      ...
      >
        ...
        >
          ...
          <a
            href="#"
            class="inline-block rounded-md p-2 bg-white dark:bg-dark-eval-1"
          >
    ...
    return () => (
      <div class="flex flex-col items-center justify-center gap-6 lg:flex-row">
        ...
        >
          {({ iconSizeClasses }) => (
            <>
              <VueJsIcon aria-hidden="true" class={[iconSizeClasses]} />
        ...
        >
          {({ iconSizeClasses }) => (
            <>
              <HtmlIcon aria-hidden="true" class={[iconSizeClasses]} />
        ...
        >
          {({ iconSizeClasses }) => (
            <>
              <LaravelIcon aria-hidden="true" class={[iconSizeClasses]} />
...
export default defineComponent({
  setup() {
    ...
    return () => (
      <div class="min-h-screen text-gray-900 bg-gray-100 dark:bg-dark-eval-0">
        <Navbar />
